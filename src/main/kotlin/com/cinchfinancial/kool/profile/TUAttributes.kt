...
class TUAttributes(properties: Map<String, Any?>) : BaseAttributes(properties){
    ...
    val total_monthly_payments_revolving_cards: Decimal by scalarValue(properties)
    val total_balance_revolving_cards: Decimal by scalarValue(properties)
    val total_balance_open_trades: Decimal by scalarValue(properties)
    val tax_liens: Int by scalarValue(properties)
    val revolving_apr: Decimal by scalarValue(properties)
    ...
    val average_debt_service: Decimal by scalarValue(properties)
