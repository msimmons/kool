...
class UserAttributes(properties: Map<String, Any?>): BaseAttributes(properties){
    ...
    val unlinked_cash: Decimal by scalarValue(properties)
    val number_of_children: Int by scalarValue(properties)
    val life_insurance_amount: Decimal by scalarValue(properties)
    ...
    val earmarked_cash: Decimal by scalarValue(properties)
    val car_status: String by scalarValue(properties)
    val annual_individual_income: Decimal by scalarValue(properties)
    val annual_household_income: Decimal by scalarValue(properties)
