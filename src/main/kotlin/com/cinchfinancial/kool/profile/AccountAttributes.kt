...
class AccountAttributes(properties: Map<String, Any?>) : BaseAttributes(properties) {
    ...
    class TU(properties: Map<String, Any?>) : BaseAttributes(properties) {
        ...
        val last_payment: Numeric by scalarValue(properties)
        val last_statement_balance: Numeric by scalarValue(properties)
        ...
        val monthly_payment: Numeric by scalarValue(properties)
        val delinquencies_90_days: Numeric by scalarValue(properties)
        val portfolio_type: String by scalarValue(properties)
        val name: String by scalarValue(properties)
        val credit_limit: Numeric by scalarValue(properties)
        val months_history: Numeric by scalarValue(properties)
        val delinquencies_30_days: Numeric by scalarValue(properties)
        ...
        val high_credit: Numeric by scalarValue(properties)
        val delinquencies_60_days: Numeric by scalarValue(properties)
        val id: String by scalarValue(properties)
    ...
    class TUHistory(properties: Map<String, Any?>) : BaseAttributes(properties) {
        val scheduled_monthly_payment: Numeric by scalarValue(properties)
        ...
        val high_credit: Numeric by scalarValue(properties)
        val current_balance: Numeric by scalarValue(properties)
        val credit_limit: Numeric by scalarValue(properties)
        val actual_payment: Numeric by scalarValue(properties)
    }

    class TUSummary(properties: Map<String, Any?>) : BaseAttributes(properties) {
        val scheduled_monthly_payment_amount: Numeric by scalarValue(properties)
        val most_recent_payment_amount: Numeric by scalarValue(properties)
