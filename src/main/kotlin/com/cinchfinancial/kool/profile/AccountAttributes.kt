...
class AccountAttributes(properties: Map<String, Any?>) : BaseAttributes(properties) {
    ...
    class UserInput(properties: Map<String, Any?>) : BaseAttributes(properties) {
        ...
        val balance : BigDecimal? by scalarValue(properties)
    ...
    class TU(properties: Map<String, Any?>) : BaseAttributes(properties) {
        ...
        val last_payment: BigDecimal? by scalarValue(properties)
        val last_statement_balance: BigDecimal? by scalarValue(properties)
        ...
        val monthly_payment: BigDecimal? by scalarValue(properties)
        ...
        val credit_limit: BigDecimal? by scalarValue(properties)
        ...
        val high_credit: BigDecimal? by scalarValue(properties)
    ...
    class TUHistory(properties: Map<String, Any?>) : BaseAttributes(properties) {
        val scheduled_monthly_payment: BigDecimal? by scalarValue(properties)
        ...
        val high_credit: BigDecimal? by scalarValue(properties)
        val current_balance: BigDecimal? by scalarValue(properties)
        val credit_limit: BigDecimal? by scalarValue(properties)
        val actual_payment: BigDecimal? by scalarValue(properties)
    }

    class TUSummary(properties: Map<String, Any?>) : BaseAttributes(properties) {
        val scheduled_monthly_payment_amount: BigDecimal? by scalarValue(properties)
        val most_recent_payment_amount: BigDecimal? by scalarValue(properties)
